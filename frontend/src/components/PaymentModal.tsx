...
export const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      setError(
        'Amount received is less than total bill amount.'
      );
      return;
    }
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-lg text-on-surface-variant">
                    ₹
                  </span>
